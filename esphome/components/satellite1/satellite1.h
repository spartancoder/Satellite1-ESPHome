...
enum dc_doa_cmd_id {
   GET_BEAM_ANGLE = (110 | CONTROL_CMD_READ_BIT),
   SET_BEAM_ANGLE = 111,
   GET_MVDR_MODE = (112 | CONTROL_CMD_READ_BIT),
   SET_MVDR_MODE = 113,
   GET_BEAM_CONFIDENCE = (114 | CONTROL_CMD_READ_BIT),
   GET_DOA_DATA = (115 | CONTROL_CMD_READ_BIT)
};
}
